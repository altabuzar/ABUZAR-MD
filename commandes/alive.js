...
zokou(
  ...
  async (dest, zk, commandeOptions) => {
    ...
    const fullImageUrl = "https://i.ibb.co/mC3TX6dq/c049579499409688.jpg"; // Full image URL
    const smallThumbnailUrl = "https://i.ibb.co/mC3TX6dq/c049579499409688.jpg"; // Small thumbnail URL
    const randomAudio = "https://files.catbox.moe/wdap4t.mp3"; // Voice note URL
    const sourceUrl = "https://whatsapp.com/channel/0029VawH7muGpLHWRj7SoR3E"; // Channel link
    ...
    try {
      ...
      await zk.sendMessage(dest, {
        ...
        contextInfo: {
          externalAdReply: {
            title: `💦 Message from: ${contactName}\n⚙️Abuzar Md Alive⚙️`, // Your contact in WhatsApp status format
...
zokou(
  ...
  async (dest, zk, commandeOptions) => {
    ...
    const smallThumbnailUrl = "https://i.ibb.co/mC3TX6dq/c049579499409688.jpg"; // Small thumbnail URL
    const randomAudio = "https://files.catbox.moe/wdap4t.mp3"; // Voice note URL
    const sourceUrl = "https://i.ibb.co/mC3TX6dq/c049579499409688.jpg"; // Channel link
    const contactName = commandeOptions?.ms?.pushName || "Unknown Contact"; // Sender's name or "Unknown Contact"
    ...
    try {
      ...
      await zk.sendMessage(dest, {
        ...
        contextInfo: {
          externalAdReply: {
            title: `🌟 Message from: ${contactName}\n⚙️ Abuzar Md Alive ⚙️`, // Your contact in WhatsApp status format
            body: "Yoh don't disturb am active🥱 Tap here",
            thumbnailUrl: smallThumbnailUrl, // Small thumbnail displayed below
            mediaType: 1, // Indicate this is an image
            renderLargerThumbnail: true, // Ensure thumbnail is displayed in full
